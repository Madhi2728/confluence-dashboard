...
const UI_TEXT = {
  ...
  ml: {
    opsTab: "അഡ്മിഷൻ ഓപ്സ്", navTab: "ഇൻഷുറൻസ് നാവിഗേറ്റർ",
    viewingFor: "ഇതിനായി കാണിക്കുന്നു", editUpdate: "എഡിറ്റ് / അപ്ഡേറ്റ്",
    insuranceSummary: "ഇൻഷുറൻസ് സംഗ്രഹം", insurer: "ഇൻഷുറർ", policyType: "പോളിസി തരം",
    coverageLimit: "കവറേജ് പരിധി", roomEligibility: "മുറി യോഗ്യത", exclusions: "ഒഴിവാക്കലുകൾ",
    suggestedHospitals: "നിർദ്ദേശിക്കപ്പെട്ട ആശുപത്രികളും മുറികളും", careJourney: "ചികിത്സാ യാത്ര",
    possibleAlternatives: "സാധ്യമായ ബദലുകൾ", save: "സേവ് ചെയ്യുക", cancel: "റദ്ദാക്കുക",
    completed: "പൂർത്തിയായി", current: "നിലവിലുള്ളത്", upcoming: "വരാനിരിക്കുന്നത്",
    disclaimer: "ഇത് തീരുമാനമെടുക്കാൻ സഹായിക്കുന്ന വിവരങ്ങൾ മാത്രമാണ് — ഇത് ഒരു മെഡിക്കൽ രോഗനിർണയമോ ബാധ്യതയുള്ള ഇൻഷുറൻസ് ഉറപ്പോ അല്ല. അന്തിമ കവറേജ് വിവരങ്ങൾ എപ്പോഴും നിങ്ങളുടെ ഇൻഷുററുമായും ആശുപത്രിയുമായും സ്ഥിരീകരിക്കുക.",
    takeawayPrefix: "നിങ്ങൾക്ക്", takeawayMid: "വരെ", takeawayRoom: "മുറിക്ക് കവറേജ് ഉണ്ട്. തിരഞ്ഞെടുക്കുന്നത്:",
    takeawaySuffix: "കൂടുതൽ പോക്കറ്റ് ചെലവിന് കാരണമായേക്കാം.",
    uploadCard: "ഇൻഷുറൻസ് കാർഡ് അപ്‌ലോഡ് ചെയ്യുക", analyzing: "ഡോക്യുമെന്റ് വിശകലനം ചെയ്യുന്നു…",
    analyzeSubLabels: ["കാർഡ് വിവരങ്ങൾ വായിക്കുന്നു…", "പോളിസി ഫീൽഡുകൾ പൊരുത്തപ്പെടുത്തുന്നു…", "കവറേജ് പരിധികൾ പരിശോധിക്കുന്നു…"],
    extractedNote: "നിങ്ങൾ അപ്‌ലോഡ് ചെയ്ത ഡോക്യുമെന്റിൽ നിന്ന് എടുത്തത് — താഴെ പരിശോധിച്ച് സേവ് ചെയ്യുക.",
    extractionIncomplete: "ചില ഫീൽഡുകൾ വായിക്കാൻ കഴിഞ്ഞില്ല — ദയവായി പരിശോധിച്ച് സ്വയം എഡിറ്റ് ചെയ്യുക.",
    extractionUnavailable: "എക്‌സ്ട്രാക്ഷൻ സേവനത്തിലേക്ക് എത്താൻ കഴിഞ്ഞില്ല — പ്ലേസ്‌ഹോൾഡർ ഡെമോ ഡാറ്റ കാണിക്കുന്നു. ദയവായി പരിശോധിച്ച് സ്വയം എഡിറ്റ് ചെയ്യുക.",
    askTitle: "Ask Confluence", askPlaceholder: "കവറേജ്, മുറികൾ, അല്ലെങ്കിൽ അടുത്ത ഘട്ടങ്ങൾ കുറിച്ച് ചോദിക്കുക…", send: "അയയ്ക്കുക",
    askIntro: "നിങ്ങളുടെ കവറേജ്, ആശുപത്രികൾ, അല്ലെങ്കിൽ ചികിത്സാ യാത്രയെക്കുറിച്ച് എന്നോട് എന്തും ചോദിക്കുക.",
    selectLanguage: "ഭാഷ തിരഞ്ഞെടുക്കുക", insuranceGuidance: "ഇൻഷുറൻസ് മാർഗനിർദേശം", matchLabel: "പൊരുത്തം",
    inNetwork: "ഇൻ-നെറ്റ്‌വർക്ക്", outOfNetwork: "ഔട്ട്-ഓഫ്-നെറ്റ്‌വർക്ക്",
    formInsurer: "ഇൻഷുറർ / സ്കീം", formPolicyType: "പോളിസി തരം", formCoverageLimit: "കവറേജ് പരിധി (₹)",
    formRoomEligibility: "മുറി യോഗ്യത", formExclusions: "ഒഴിവാക്കലുകൾ (കോമ കൊണ്ട് വേർതിരിക്കുക)",
    hospitalReasonInNetCovered: "ഇൻ-നെറ്റ്‌വർക്ക്; {rooms} നിങ്ങളുടെ പോളിസിയിൽ കവർ ചെയ്യുന്നു — cashless സെറ്റിൽമെന്റ് പ്രതീക്ഷിക്കാം.",
    hospitalReasonInNetUncovered: "ഇൻ-നെറ്റ്‌വർക്ക് ആണ്, എന്നാൽ ലഭ്യമായ മുറികൾ ({rooms}) നിങ്ങളുടെ കവർ ചെയ്ത വിഭാഗങ്ങൾക്ക് പുറത്താണ് — co-pay ബാധകമായേക്കാം.",
    hospitalReasonOutOfNetwork: "ഔട്ട്-ഓഫ്-നെറ്റ്‌വർക്ക് — ഇതിന് സാധാരണയായി cashless അല്ല, reimbursement ക്ലെയിം ആവശ്യമായി വരും.",
  },
};

const STAGE_I18N = {
  admission: {
    label: { en: "Admission", ta: "அனுமதி", hi: "प्रवेश", kn: "ಪ್ರವೇಶ", te: "ప్రవేశం", ml: "അഡ്മിഷൻ" },
    guidance: {
      ...
      ml: "നിങ്ങളുടെ പോളിസി നെറ്റ്‌വർക്ക് ആശുപത്രികളിൽ ജനറൽ വാർഡ്, സെമി-പ്രൈവറ്റ് മുറികൾക്ക് കാഷ്‌ലെസ് സെറ്റിൽമെന്റോടെ കവറേജ് നൽകുന്നു. പ്രൈവറ്റ് അല്ലെങ്കിൽ ഡീലക്സ് മുറി തിരഞ്ഞെടുത്താൽ ദിവസേന അധിക കോ-പേ നൽകേണ്ടിവരും.",
    },
    altTitles: {
      ...
      ml: ["പ്രൈവറ്റ് മുറിയിലേക്ക് അപ്‌ഗ്രേഡ് ചെയ്യുക", "ജനറൽ വാർഡിലേക്ക് ഡൗൺഗ്രേഡ് ചെയ്യുക", "മറ്റൊരു നെറ്റ്‌വർക്ക് ആശുപത്രിയിലേക്ക് മാറ്റുക"],
    },
    altDetails: {
      en: [
      ...
      ml: [
        "നിങ്ങളുടെ കവർ ചെയ്ത മുറി വിഭാഗത്തിന് പുറത്ത് ദിവസേന ഏകദേശം ₹1,800 അധിക co-pay.",
        "നിങ്ങളുടെ പോളിസിയിൽ പൂർണമായും cashless — അധിക ചെലവില്ല.",
        "നിങ്ങൾ ആഗ്രഹിക്കുന്ന മുറി തരം ഇവിടെ ലഭ്യമല്ലെങ്കിൽ, സമീപത്തുള്ള മറ്റ് നെറ്റ്‌വർക്ക് ആശുപത്രികളിൽ ഇന്ന് സ്ഥലം ഉണ്ടാകാം.",
      ],
    },
  },
  investigation: {
    label: { en: "Investigation", ta: "பரிசோதனை", hi: "जांच", kn: "ತನಿಖೆ", te: "పరిశోధన", ml: "പരിശോധന" },
    guidance: {
      ...
      ml: "ഈ ഘട്ടത്തിൽ നടത്തുന്ന പരിശോധനകൾ സാധാരണയായി നിങ്ങളുടെ പോളിസിയുടെ സബ്-ലിമിറ്റ് വരെ കവർ ചെയ്യപ്പെടും. നെറ്റ്‌വർക്കിന് പുറത്തുള്ള പരിശോധനകൾക്ക് റീഇംബേഴ്‌സ്‌മെന്റ് ക്ലെയിമിനായി ഒറിജിനൽ ബില്ലുകളും റിപ്പോർട്ടുകളും സൂക്ഷിക്കുക.",
    },
    altTitles: {
      ...
      ml: ["ആശുപത്രിക്കുള്ളിലെ ഡയഗ്നോസ്റ്റിക് പാക്കേജ്", "നെറ്റ്‌വർക്കിന് പുറത്തുള്ള ലാബ് പരിശോധനകൾ"],
    },
    altDetails: {
      en: [
      ...
      ml: [
        "നിങ്ങളുടെ പോളിസി സബ്-ലിമിറ്റിന് കീഴിൽ കവർ, cashless.",
        "reimbursement ക്ലെയിം ആവശ്യമാണ് — ഒറിജിനൽ ബില്ലുകളും റിപ്പോർട്ടുകളും സൂക്ഷിക്കുക.",
      ],
    },
  },
  procedure: {
    label: { en: "Procedure", ta: "சிகிச்சை", hi: "प्रक्रिया", kn: "ಚಿಕಿತ್ಸೆ", te: "ప్రక్రియ", ml: "ചികിത്സ" },
    guidance: {
      ...
      ml: "സ്റ്റാൻഡേർഡ് ചികിത്സാ ഉപഭോഗ വസ്തുക്കളും ഇംപ്ലാന്റുകളും നിങ്ങളുടെ പ്രസവ ആനുകൂല്യത്തിന് കീഴിൽ കവർ ചെയ്യപ്പെടും. പ്രീമിയം അല്ലെങ്കിൽ ബ്രാൻഡഡ് വസ്തുക്കൾ ഭാഗികമായി മാത്രം കവർ ചെയ്യപ്പെട്ടേക്കാം — നിങ്ങളുടെ പോളിസിയുടെ അനുബന്ധം പരിശോധിക്കുക.",
    },
    altTitles: {
      ...
      ml: ["സ്റ്റാൻഡേർഡ് ഉപഭോഗ വസ്തുക്കൾ", "പ്രീമിയം/ബ്രാൻഡഡ് ഉപഭോഗ വസ്തുക്കൾ"],
    },
    altDetails: {
      en: [
      ...
      ml: [
        "പൂർണമായി കവർ, cashless സെറ്റിൽമെന്റ്.",
        "ഭാഗിക കവറേജ് മാത്രം — നിങ്ങളുടെ co-pay ശതമാനത്തിന് അനുബന്ധം പരിശോധിക്കുക.",
      ],
    },
  },
  recovery: {
    label: { en: "Recovery", ta: "மீட்பு", hi: "रिकवरी", kn: "ಚೇತರಿಕೆ", te: "కోలుకోవడం", ml: "സുഖം പ്രാപിക്കൽ" },
    guidance: {
      ...
      ml: "ചികിത്സയ്ക്ക് ശേഷമുള്ള സുഖം പ്രാപിക്കൽ ദിവസങ്ങൾ നിങ്ങളുടെ അർഹമായ മുറി വിഭാഗത്തിൽ കാഷ്‌ലെസ് ആയി തുടരും. പോളിസിയുടെ ദിന-പരിധി കടക്കുന്ന താമസത്തിന് അധിക ചാർജുകൾ ബാധകമായേക്കാം.",
    },
    altTitles: {
      ...
      ml: ["ദിന-പരിധി കടന്ന ദീർഘിപ്പിച്ച താമസം", "ഹോം കെയറോടെ നേരത്തെയുള്ള ഡിസ്ചാർജ്"],
    },
    altDetails: {
      en: [
      ...
      ml: [
        "നിങ്ങളുടെ പോളിസിയുടെ കവർ ചെയ്ത കാലാവധി തീരുന്നതോടെ ദിവസേന അധിക ചാർജുകൾ ബാധകമാകും.",
        "മുറി-ചെലവ് കുറയ്ക്കാം — നിങ്ങളുടെ പോളിസിയിൽ home-care rider ഉണ്ടോ എന്ന് പരിശോധിക്കുക.",
      ],
    },
  },
};
