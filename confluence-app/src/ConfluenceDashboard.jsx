...
const STAGE_I18N = {
  admission: {
    label: { en: "Admission", ta: "அனுமதி", hi: "प्रवेश" },
    guidance: {
  ...
  investigation: {
    label: { en: "Investigation", ta: "பரிசோதனை", hi: "जांच" },
    guidance: {
  ...
  procedure: {
    label: { en: "Procedure", ta: "சிகிச்சை", hi: "प्रक्रिया" },
    guidance: {
  ...
  recovery: {
    label: { en: "Recovery", ta: "மீட்பு", hi: "रिकवरी" },
    guidance: {
